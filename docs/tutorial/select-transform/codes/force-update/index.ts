...
export const forceUpdateCodes = createShapeCodesData();

forceUpdateCodes.vanilla.js = `import Konva from 'konva';
...
forceUpdateCodes.react = `import { Stage, Layer, Text, Rect, Group, Transformer } from 'react-konva';
...
forceUpdateCodes.vue.app = `<template>
  <div>
