...
export const resizeTextCodes = createShapeCodesData();
resizeTextCodes.vanilla.js = `import Konva from 'konva';
...
resizeTextCodes.react = `import { Stage, Layer, Text, Transformer } from 'react-konva';
...
resizeTextCodes.vue.app = `<template>
