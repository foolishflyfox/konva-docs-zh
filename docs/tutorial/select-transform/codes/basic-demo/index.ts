...
export const basicDemoCodes = createShapeCodesData();
basicDemoCodes.vanilla.js = `import Konva from 'konva';
...
basicDemoCodes.react = `import { Stage, Layer, Rect, Transformer } from 'react-konva';
...
basicDemoCodes.vue.app = `<template>
  <v-stage
    :config="stageSize"
