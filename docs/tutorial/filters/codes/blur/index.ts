...
export * from "./demo";
export const blurCodes = createShapeCodesData();
blurCodes.vanilla.js = `import Konva from 'konva';
...
blurCodes.react = `import { Stage, Layer, Image } from 'react-konva';
