...
export const invertCodes = createShapeCodesData();

invertCodes.vanilla.js = `import Konva from 'konva';
...
invertCodes.react = `import { Stage, Layer, Image } from 'react-konva';
