...
export const thresholdCodes = createShapeCodesData();

thresholdCodes.vanilla.js = `import Konva from 'konva';
...
thresholdCodes.react = `import { Stage, Layer, Image } from 'react-konva';
...
thresholdCodes.vue.app = `<template>
  <div>
