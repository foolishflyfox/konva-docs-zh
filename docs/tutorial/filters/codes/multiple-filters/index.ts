...
export const multipleFiltersCodes = createShapeCodesData();
multipleFiltersCodes.vanilla.js = `import Konva from 'konva';
...
multipleFiltersCodes.react = `import { Stage, Layer, Image } from 'react-konva';
...
multipleFiltersCodes.vue.app = `<template>
  <div>
