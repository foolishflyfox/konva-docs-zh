...
export * from "./demo";
export const hslCodes = createShapeCodesData();
hslCodes.vanilla.js = `import Konva from 'konva';
...
hslCodes.react = `import { Stage, Layer, Image } from 'react-konva';
