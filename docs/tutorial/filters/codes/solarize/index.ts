...
export const solarizeCodes = createShapeCodesData();
solarizeCodes.vanilla.js = `import Konva from 'konva';
...
solarizeCodes.react = `import { Stage, Layer, Image } from 'react-konva';
...
solarizeCodes.vue.app = `<template>
  <div>
