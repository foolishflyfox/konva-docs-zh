...
export * from "./demo";
export const pointerEventsCodes = createShapeCodesData();
pointerEventsCodes.vanilla.js = `import Konva from 'konva';
...
pointerEventsCodes.react = `import { Stage, Layer, RegularPolygon, Text } from 'react-konva';
...
pointerEventsCodes.vue.app = `<template>
