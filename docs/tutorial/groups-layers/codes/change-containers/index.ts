...
export const changeContainersCodes = createShapeCodesData();
changeContainersCodes.vanilla.js = `import Konva from 'konva';
...
changeContainersCodes.react = `import { Stage, Layer, Rect, Group } from 'react-konva';
...
changeContainersCodes.vue.app = `<template>
  <div>
