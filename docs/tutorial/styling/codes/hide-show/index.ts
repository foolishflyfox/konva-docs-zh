...
export const hideShowCodes = createShapeCodesData();
hideShowCodes.vanilla.js = `import Konva from 'konva';
...
hideShowCodes.react = `import React, { useState } from 'react';
...
hideShowCodes.vue.app = `<template>
  <div style="position: relative;">
