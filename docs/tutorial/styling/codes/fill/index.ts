...
export * from "./demo";
export const fillCodes = createShapeCodesData();
fillCodes.vanilla.js = `import Konva from 'konva';
...
fillCodes.react = `import React from 'react';
