...
export * from "./demo";
export const dropEventsCodes = createShapeCodesData();
dropEventsCodes.vanilla.js = `import Konva from 'konva';
...
dropEventsCodes.react = `import { Stage, Layer, Text, Star } from 'react-konva';
...
dropEventsCodes.vue.app = `<template>
