...
| <a class="ar"/>`clipX`(可选)      | `Number`   | 裁剪矩形区域的 X 坐标                     |
| <a class="ar"/>`clipY`(可选)      | `Number`   | 裁剪矩形区域的 Y 坐标                     |
| <a class="ar"/>`clipWidth`(可选)  | `Number`   | 裁剪矩形区域宽度                          |
| <a class="ar"/>`clipHeight`(可选) | `Number`   | 裁剪矩形区域高度                          |
| <a class="ar"/>`clipFunc`(可选)   | `function` | 自定义裁剪函数,用于定义容器的裁剪区域形状 |
